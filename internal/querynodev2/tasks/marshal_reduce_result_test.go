...
func buildDFWithGroupByArrowArray(
	...
	builder.SetFieldType(groupByCol, groupByType)
	builder.SetFieldID(groupByCol, groupByFieldID)
	builder.SetFieldNullable(groupByCol, groupByNullable)
